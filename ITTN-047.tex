...
\setDocAbstract{%
The following document details the plan to deploy the fibers, devices and configuration to provide a solution for the connectivity on the 3rd floor laboratories at the Vera C. Rubin buildong at Pachon Mountain. 
}
